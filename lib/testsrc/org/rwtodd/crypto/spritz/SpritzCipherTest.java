...
public class SpritzCipherTest {
    ...
    public void testHashTypes() throws java.io.IOException {
        ...
        Assertions.assertArrayEquals(arrHash, isHash);
    }
    ...
    public void testHashes() {
        ...
        Assertions.assertArrayEquals(new byte[]{(byte)0x02, (byte)0x8f, (byte)0xa2, (byte)0xb4, 
        ...
        Assertions.assertArrayEquals(new byte[]{(byte)0xac, (byte)0xbb, (byte)0xa0, (byte)0x81, 
        ...
        Assertions.assertArrayEquals(new byte[]{(byte)0xff, (byte)0x8c, (byte)0xf2, (byte)0x68, 
